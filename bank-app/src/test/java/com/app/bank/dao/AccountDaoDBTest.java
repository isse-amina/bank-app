...
public class AccountDaoDBTest {
    ...
    public void testUpdateAccount() {
        ...
        assertEquals(initialAccount.getNumber(), "1234567890");
        ...
        assertEquals(updatedAccount.getNumber(), "2345678901");
